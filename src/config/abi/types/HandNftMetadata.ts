...
export interface HandNftMetadataInterface extends utils.Interface {
  functions: {
    ...
    "getNftAllInfo(uint256)": FunctionFragment;
    "getNftsByaddress(address)": FunctionFragment;
    "getOwner(uint256)": FunctionFragment;
    "haveClaims(address,address,uint256)": FunctionFragment;
    "haveHandMint(address)": FunctionFragment;
    "haveMints(address,address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getNftAllInfo",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "haveClaims", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "haveHandMint",
    data: BytesLike
  ): Result;
  decodeFunctionResult(functionFragment: "haveMints", data: BytesLike): Result;
...
export interface HandNftMetadata extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HandNftMetadataInterface;
